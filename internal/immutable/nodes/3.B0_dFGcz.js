import"../chunks/CWj6FrbW.js";import"../chunks/D8W01uTf.js";import{f as a,a as n,n as o}from"../chunks/B5V5GHYD.js";var r=a(`<h1>About</h1> <div><p>I am a software developer currently working at <a target="_blank" href="https://itera.com">Itera</a>. I used to work at <a target="_blank" href="https://uio.no">University of Oslo</a>.</p> <p>My specialty is backend programming using python. Mostly to make integrations between different
		systems. I have also written services that handle storing, serving and transferring, personal
		and financial information using a wide range of designs.</p> <p>For database access I have done both the old school approach of writing raw SQL, as well as
		...
		too.</p> <p>On the data analysis side I've used Microsoft Fabric for a while. It's nice with the simple
		feedback but the source control is kind of slapped on at the end, making it uncomfortable when
		you're used to strict CI/CD pipelines and such.</p></div>`,1);function h(e){var t=r();o(2),n(e,t)}export{h as component};
