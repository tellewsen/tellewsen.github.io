...
<div>
	<p>
		I am a software developer currently working at <a target="_blank" href="https://itera.com"
			>Itera</a
	...
	<p>
		...
		precisely what you want, I'd take the ORM approach every time.
	</p>
	<p>
		I've set up REST apis using Flask and FastAPi, serving them using Gunicorn and Uvicorn. Both are
		perfectly fine.
	</p>
	<p>
		I prefer using pytest for unit testing over the unittest library, simply because of the number
		of characters needed for assertions.
	</p>
	<p>
		I know how to make a frontend using the Django templating system, but I prefer the split
