...
<div>
	...
	<p>
		I also know how to make websites using typescript with React.js and some of the regular
		libraries typically used. As you can see, this site is written in Svelte so that works too.
	</p>
	<p>
		...
		python notebooks is familiar territory at least.
	</p>
	<p>On a more personal note i enjoy playing video games and listening to heavy metal.</p>
</div>
